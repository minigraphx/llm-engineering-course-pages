...
Last updated 2026-09-24 — see [What's new](/changelog).
...
- **Measure what a defence against prompt injection actually buys, one step at a
  time** — a cumulative ladder run against R02's retrieval pipeline and AG02's
  agent, on local models only, in [AG03](/agent-injection).
...
R01–R02 and the Applied: Agents units AG01, AG02 and AG03. German localisation is complete.
Still open: the supplied larger data packs (M1A),
