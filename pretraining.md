...
Allow 90–120 minutes. You need the [document pipeline](/llm-engineering-course-pages/data-pipeline),
[Mini-GPT](/llm-engineering-course-pages/mini-gpt), gradients and the meaning of cross entropy. Complete
[setup](/llm-engineering-course-pages/setup) first; every required command runs on CPU without downloads.
