...
[core gate](/llm-engineering-course-pages/mini-gpt-gate). You need [tensor shapes](/llm-engineering-course-pages/foundations-02-shapes),
[autograd](/llm-engineering-course-pages/foundations-05-mlp-autograd), the [document pipeline](/llm-engineering-course-pages/data-pipeline),
and [causal attention](/llm-engineering-course-pages/attention). Either the standalone route or the
[Godot-RL bridge](/llm-engineering-course-pages/foundations-godot-rl-bridge) leads here.
...
From the repository root after [setup](/llm-engineering-course-pages/setup):
...
Do not commit generated corpora or checkpoints. Move to the [core gate](/llm-engineering-course-pages/mini-gpt-gate)
