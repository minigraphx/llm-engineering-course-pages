...
danach folgt die [Kernprüfung](/llm-engineering-course-pages/de/mini-gpt-gate). Voraussetzungen:
[Tensorformen](/llm-engineering-course-pages/de/foundations-02-shapes), [Autograd](/llm-engineering-course-pages/de/foundations-05-mlp-autograd),
[Dokumentpipeline](/llm-engineering-course-pages/de/data-pipeline) und [kausale Attention](/llm-engineering-course-pages/de/attention).
Sowohl der eigenständige Einstieg als auch die
[Godot-RL-Brücke](/llm-engineering-course-pages/de/foundations-godot-rl-bridge) führen hierher.
...
Nach dem [Setup](/llm-engineering-course-pages/de/setup) im Repository-Verzeichnis:
